...
#define SMART_BAND_STEP_GOAL 8000
...
typedef enum
{
  ...
  SMART_BAND_PAGE_WEATHER,
  SMART_BAND_PAGE_CALENDAR,
  SMART_BAND_PAGE_MUSIC,
  SMART_BAND_PAGE_TIMER,
  SMART_BAND_PAGE_CALCULATOR,
  SMART_BAND_PAGE_TODO,
  SMART_BAND_PAGE_HOME,
  SMART_BAND_PAGE_SETTINGS,
  SMART_BAND_PAGE_CHART,
  SMART_BAND_PAGE_PET,
  SMART_BAND_PAGE_WOODEN_FISH,
