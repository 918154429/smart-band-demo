...
- 小应用页面：已模仿 openvela 原生 demo 与快应用 examples 实现天气、日历、音乐、
  沙漏计时、计算器、待办、家居控制、设置、健康趋势、虚拟宠物和电子木鱼 11 个
  手环内页面。实现为当前原生 LVGL 应用内部页面，没有直接调用示例仓库的应用入口。
